(function () {
  ...
  function useHermesAmpData() {
    ...
    React.useEffect(function () {
      ...
      function load() {
        ...
        Promise.all([statusPromise, sessionsPromise, analyticsPromise, logsPromise])
  ...
  function Meter(props) {
    ...
    return e(
      "div",
      { className: "hermes-amp-meter-row" },
  ...
  function Sidebar() {
    ...
    var status = readStatusLabel(data.status);
    var sessionLoad = clamp(sessions.length * 12.5, 8, 100);
    var signal = data.error ? 12 : 88;
    var cache = data.status && typeof data.status.memory_percent === "number"
      ? clamp(data.status.memory_percent, 0, 100)
      : clamp(34 + sessions.length * 7, 22, 96);
    ...
    return e(
      ...
      e(
        "div",
        { className: "hermes-amp-window" },
        e("div", { className: "hermes-amp-titlebar" }, e("span", null, "SIGNAL")),
        e(Meter, { label: "AGENT", value: signal }),
        e(Meter, { label: "QUEUE", value: sessionLoad }),
        e(Meter, { label: "CACHE", value: cache })
      ),
      e(
        "div",
        { className: "hermes-amp-window" },
  ...
  function AmpDesktopPage() {
    ...
    return e(
      ...
      e(
        AmpWindow,
        { title: "SYSTEM", className: "is-desktop-system" },
        e(StatTiles, { data: data }),
        e("div", { className: "hermes-amp-meter-stack" },
          e(Meter, { label: "AGENT", value: data.error ? 12 : 88 }),
          e(Meter, { label: "QUEUE", value: clamp((data.sessionTotal || 0) * 10, 8, 100) })
        )
      ),
      e(
        AmpWindow,
  ...
  function SessionsDeck() {
    ...
    return e(
      ...
      e(
        AmpWindow,
        { title: "SYSTEM METERS", className: "is-meters" },
        e(StatTiles, { data: data }),
        e("div", { className: "hermes-amp-meter-stack" },
          e(Meter, { label: "AGENT", value: data.error ? 12 : 88 }),
          e(Meter, { label: "QUEUE", value: clamp((data.sessionTotal || 0) * 10, 8, 100) })
